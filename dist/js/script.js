...
$(document).ready(function(){
	...
	/*por 'SCROLL' se cambia :( 
	datos.forEach(function(e, f){
		var clases = f + 1;
		var infoPin = '<div class="caja-contenido caja-' + clases + '"><img src="dist/img/' + e.image_url + '" class="img-json img-' + clases +' "><h4>' + e.title + '</h4><p>' + e.description + '</p><img src="assets/img/user_icon.png" class="user-icon circle"><h5>' + e.username + '</h5><span>#' + e.hashtag + '</span></div>';
		$(".contenido-json").append(infoPin);
	});*/

	$(window).scroll(function(){//infinitamente despues del dato 21.
...
/*if(e.id =% 2 == 0){
			$(".img-json").addClass('img-dos');
			console.log("HOLA");
		}else{
			$(".img-json").addClass('img-tres');
			console.log("chao");
		}*/
	/*
	function classes(){
	...
	classes();
	var elem = document.querySelector('.contenido-json');
	var msnry = new Masonry( elem, {
	  // options
	  itemSelector: '.img-json'
	});*/
